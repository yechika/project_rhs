  ...
  return (
    <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="flex justify-center mt-10">
        <Link
          to="/products"
          className="inline-flex items-center text-indigo-600 hover:text-indigo-700 font-medium px-6 py-3 rounded-md bg-white border border-indigo-600 hover:bg-indigo-50 transition-colors duration-200"
        >
          View All Products
